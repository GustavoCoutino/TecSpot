...
function getAllEstacionamientos() {
    ...
    .then(data => {
        ...
        document.getElementById('estacionamientosList').innerText = JSON.stringify(data);
    })
    .catch(error => console.error('Error:', error));
}
...
function getAllEstacionamientosDisponibles() {
    ...
    .then(data => {
        ...
        document.getElementById('estacionamientosDisponiblesList').innerText = JSON.stringify(data);
    })
    .catch(error => console.error('Error:', error));
}
